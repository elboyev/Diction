...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE words (word TEXT, translation TEXT, isDeleted INTEGER, " +
    ...
    public ArrayList<Word> getAllWords() {
        ...
        @SuppressLint("Recycle") Cursor cursor = db.rawQuery("SELECT word, translation, sourcePosition, targetPosition FROM words", null);
